...
insert into dependencies(id , dependency_type, task_parent_id , task_id) values (-1, 1, -1, -6);
...
insert into dependencies(id , dependency_type, task_parent_id , task_id) values (-2, 2, -4, -7);
commit;