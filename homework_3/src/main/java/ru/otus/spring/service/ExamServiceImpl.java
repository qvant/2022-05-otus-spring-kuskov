...
public class ExamServiceImpl implements ExamService {
    ...
    public void run() {
        ...
        String firstName = questionPresenter.ask(new Question(l18nService.getMessage("questions.first_name")));
        String lastName = questionPresenter.ask(new Question(l18nService.getMessage("questions.last_name")));
